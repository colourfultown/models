...
def mlp_model(inputs,is_training=True, scope="mlp_model",n_out=100):
    with tf.variable_scope(scope,"mlp_model",[inputs]):
        with slim.arg_scope(
            ...
            net = slim.fully_connected(inputs,2048,scope="fc1")
...
def trian():
    ...
    with slim.arg_scope(inception_v3.inception_v3_arg_scope()):
        logits, _ = inception_v3.inception_v3(tfimages, num_classes=2048, is_training=True)
        logits=mlp_model(logits)
...
CKPT_FILE='model22_1/A6.ckpt-3210'
TRAIN_FILE='model22_2/A6.ckpt'
STEPS=1000000
if __name__=='__main__':
    trian()

# 2850 train loss : 1.2280399799346924,val acc : 0.9539999932050705