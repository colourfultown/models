...
def trian():
    ...
    tsimgs, tslabels = tf.train.batch([tsimg, tslabel], batch_size=batch_size2, num_threads=4,
                                              capacity=500 + 4 * batch_size2)
