...
def trian():
    ...
    imgs, labels = tf.train.shuffle_batch([img, label], batch_size=batch_size1, num_threads=2,
                                          capacity=5000 + 4 * batch_size1, min_after_dequeue=5000)
